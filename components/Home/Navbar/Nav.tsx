...
const Nav = ({openNav}: Props) => {
  ...
  <div 
    ...
    <div className='flex items-center h-full justify-between w-[95%] sm:w-[90%] x1:w-[80%] mx-auto'>
        {/* LOGO */}
        <div className='flex items-center space-x-2'>
            ...
            <h1 className='text-white font-bold text-sm sm:text-base md:text-x1'>
                HomeHub
            </h1>
        </div>
        {/*Nav Links */}
        ...
        {/* Login and bugermenu */}
        <div className='flex items-center cursor-pointer text-white space-x-2 hover:text-red-400 transition-all
        duration-200'>
